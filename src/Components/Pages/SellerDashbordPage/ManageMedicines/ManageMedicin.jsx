...
import AddCategory from "../../AdminDashboardPage/ManageCatagory/AddCategory";
        ...
        <div>
            ...
            <div>
                ...
                <div className="text-center">
                    ...
                    <h2 className="lg:text-2xl text-xl font-bold p-4"> Total Medicin : {sellermedicin.length}</h2>
                </div>

                {/* Add Catagory Modal*/}
                <div className="text-end p-2">
                    {/* Open the modal using document.getElementById('ID').showModal() method */}
                    <button className="btn btn-primary" onClick={() => modalRef.current.showModal()}  >Add Medicin</button>
                ...
                <div className="overflow-x-auto">
                    ...
                    >
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            {
                                sellermedicin.map((medi, index) => <tr className="hover:bg-gray-200" key={medi._id}>
