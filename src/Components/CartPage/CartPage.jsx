...
//     // Calculate total price when shop items change
//     useEffect(() => {
//         const total = shop.reduce((total, item) => {
//             const quantity = item.quantity || 1;  // Default to 1 if undefined
//             const price = item.per_unit_price || 0;  // Default to 0 if undefined
...
//                                     <thead className="bg-green-300 dark:bg-gray-800 font-bold text-black">
//                                         <tr className="">
//                                             <th scope="col" className="py-3.5 px-4 text-sm  text-center  dark:text-gray-400">
//                                                 Name
//                                             </th>
//                                             <th scope="col" className="py-3.5 px-4 text-sm  text-center  dark:text-gray-400">
//                                                 Quantity
//                                             </th>
//                                             <th scope="col" className="px-12 py-3.5 text-sm  text-center  dark:text-gray-400">
//                                                 Price per unit
//                                             </th>
//                                             <th scope="col" className="px-4 py-3.5 text-sm  text-center  dark:text-gray-400">
//                                                 Generic Name
//                                             </th>
//                                             <th scope="col" className="px-4 py-3.5 text-sm  text-center  dark:text-gray-400">
//                                                 Category
...
//                                                 Company Name
//                                             </th>
//                                             <th scope="col" className="py-3.5 text-sm  text-center  dark:text-gray-400">
//                                                 Action
//                                             </th>
//                                         </tr>
//                                     </thead>
